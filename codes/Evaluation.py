...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--input_path", nargs="+", type=str, default="./Results-V/",  help="basic path for results")
    ...
    input_path="C:/Users/Anastasia/Desktop/E-SAI-main/Results-V/"
...
"""
    python codes/Evaluation.py --input_path=./Results-V/
"""